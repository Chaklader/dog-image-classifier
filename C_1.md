...
P(X = 3) = (5 choose 3) × 0.5^3 × (1-0.5)^(5-3) = (5!/(3!(5-3)!)) × 0.5^3 × 0.5^2 = 10 × 0.125 × 0.25 = 0.3125

So there's a 31.25% chance of getting exactly 3 heads in 5 coin flips.

The PMF can also be used to find cumulative probabilities, like the probability of getting at most 3 heads: P(X ≤ 3) =
